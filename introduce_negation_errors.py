...
def introduce_errors_in_dataset(input_path: str, output_path: str, api_key: str, model_name: str):
    ...
    allowed_languages = ['French', 'German', 'Greek', 'Italian', 'Polish']
    ...
    with open(output_path, 'a', encoding='utf-8') as f_out:
        ...
        for i, row in df.sort_values(by='no').iterrows():
            ...
            if language in processed_languages:
                print(f"  -> Skipping record with no='{record_no}' (language: {language}) as it is already processed.")
                continue
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="gpt-4o-2024-08-06", help="The model to use for introducing errors.")
